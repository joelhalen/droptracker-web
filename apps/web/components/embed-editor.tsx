...
const PLACEHOLDERS: Record<EmbedType, PlaceholderDoc[]> = {
  ...
  ca: [
    ...
    { token: "{total_points}", help: "Player's total CA points", sample: "2,085" },
    { token: "{current_tier}", help: "Player's current CA tier", sample: "Master" },
    { token: "{next_tier}", help: "Next CA tier", sample: "Grandmaster" },
    { token: "{next_tier_points}", help: "Points required for the next tier", sample: "2,672" },
    { token: "{points_left}", help: "Points still needed", sample: "587" },
    { token: "{progress}", help: "Percent toward the next tier (add your own %)", sample: "19.81" },
    PLUGIN_VERSION,
    ...COMMON_MEDIA,
  ],
  pet: [
