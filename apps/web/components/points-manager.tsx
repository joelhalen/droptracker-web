...
function RulesSection({
  ...
  return (
    <section className="space-y-3">
      <SectionHeading
        title="Award rules"
        hint="Base points per submission type. Drops award (GP value ÷ divisor) × award, rounded; the divisor is also a minimum, so a drop worth less than it awards nothing. Everything else is a flat award. Set an award to 0 to disable that type."
      />
