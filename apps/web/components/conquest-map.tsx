...
/** Tile diameter as a share of the canvas width. */
const TILE_WIDTH_PCT = 4.2;
...
export function ConquestMapCanvas({
  ...
  return (
    <div
      ref={boxRef}
      className={`border-osrs-bronze/30 relative w-full touch-manipulation select-none overflow-hidden rounded border ${className}`}
      style={{
      ...
      {tiles.map((t) => {
        ...
        const body = (
          <span className="flex flex-col items-center">
            ...
            <span
              className="mt-0.5 max-w-[9rem] truncate rounded bg-black/55 px-1 text-center leading-tight text-white/90"
