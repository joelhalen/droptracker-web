/**
 * Homepage for the sites domain — served at the apex (`osrs.site/`) via the
 * host rewrite in next.config.ts. `www.` is 301'd to the apex in nginx, and
 * the old `/temp` URL redirects here.
 *
...
const PAGE_URL = `https://${SITES_DOMAIN}/`;
